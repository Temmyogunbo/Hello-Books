...
describe('Given /api/v1/users/2/books', () => {
  describe('When I want to borrow a book', () => {
    ...
    it(
      'Then I should borrow book if all criterias are met',
      (done) => {
        chai.request(app)
          .post('/api/v1/users/2/books')
          .set('X-ACCESS-TOKEN', userToken)
...
describe('Given /api/v1/users/2/books', () => {
  describe('When I want to return a book', () => {
    it(
      'Then it should be succesful with the book id and a message returned',
      (done) => {
        chai.request(app)
...
describe('Given /api/v1/users/2/history', () => {
  describe('When I want to find a user history', () => {
    it(
      'Then it should return all the records of such user',
      (done) => {
        chai.request(app)
