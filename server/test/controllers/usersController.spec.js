...
describe('Users', () => {
  ...
  describe('Given /api/v1/users', () => {
    describe('When I want to add a user', () => {
      ...
      it('Then it should not add a user with password less than 5 characters', (done) => {
        const user = {
          fullName: 'james',
          userName: 'jerk',
          email: 'jerk@yahoo.com',
      ...
      it('Then it should not add a user if the username already exist', (done) => {
        const user = {
          fullName: 'james',
          userName: 'temmy',
          email: 'jerk@yahoo.com',
      ...
      it('Then it should return the user payload incuding token, boolean, and a success message', (done) => {
        const user = {
          fullName: 'simi',
          userName: 'simisola',
  ...
  describe('Given /api/v1/users/signin', () => {
    describe('When a user wants to sign in', () => {
      ...
      it('Then it should fail if the user does not enter the username and password fields', (done) => {
        const mockUser = {
          userName: '',
          password: 'emmanuel'
        };
      ...
      it('Then it should fail if the user does not enter password fields', (done) => {
        const mockUser = {
          userName: 'temmy',
          password: ''
        };
      ...
      it('Then it should fail if the user enters an incorrect password', (done) => {
        const mockUser = {
          userName: 'temmy',
      ...
      it('Then it should not sign in a user with password less than 5 characters', (done) => {
        const user = {
          userName: 'temmy',
          password: 'emm',
        };
      ...
      it('Then it should return users payload incuding token and a success message', (done) => {
        const mockUser = {
          userName: 'temmy',
          password: 'emmanuel'
        };
