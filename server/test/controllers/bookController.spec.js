  ...
  it('it should POST a book', (done) => {
    ...
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        res.body.should.have.property('msg').eql('You have a record successful');
  ...
  it('it should not POST a book when user is not admin', (done) => {
    ...
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        res.body.error.should.have.status(403);
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('it should update the desired field', (done) => {
    ...
    chai.request(app)
      ...
      .end((err, res) => {
        res.should.have.status(200);
        res.body.should.be.a('object');
        res.body.should.have.property('msg').eql('You updated a book');
        done();
      });
  });
  it('it should not update in case of a missing field', (done) => {
    ...
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        res.body.should.be.a('object');
        res.body.should.have.property('msg').eql('Invalid details');
        done();
      });
  });
  it('it should not update book for user other than admin', (done) => {
    const book = {
      title: 'The Pentagon',
      category: 'History',
      author: 'Edward Luttwark and Saul Singher',
  ...
  it('Should not delete book that does not exist', (done) => {
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        res.body.should.be.a('object');
        res.body.should.have.property('msg').eql('Book cannot be found');
        done();
      });
  });
