  ...
  */
  ...
  _createClass(SignUp, [{
    ...
    value: function onSubmit(event) {
      ...
      console.log('uuuuuuuu', { fullName: fullName, userName: userName, email: email, password: password });
      console.log('eeeeeeeee', this.state);
      this.props.signup({ fullName: fullName, userName: userName, email: email, password: password }).then(function () {
        // console.log('qqqqqqqqqqqqqqqq',error)
