  ...
  */
  ...
  _createClass(SignUp, [{
    ...
    value: function onSubmit(event) {
      ...
      console.log('uuuuuuuuuuu', { fullName: fullName, userName: userName, email: email, password: password });
      console.log('seeeeeeeeeeee', { fullName: fullName, userName: userName, email: email, password: password });
