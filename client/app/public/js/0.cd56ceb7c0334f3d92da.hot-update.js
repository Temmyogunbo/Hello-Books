  ...
  */
  ...
  _createClass(SignUp, [{
    ...
    value: function onSubmit(event) {
      ...
      var _console$log = console.log('eeeeeeeee', this.state),
          fullName = _console$log.fullName,
          userName = _console$log.userName,
          email = _console$log.email,
          password = _console$log.password;
