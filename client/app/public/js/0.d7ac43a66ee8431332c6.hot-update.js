...
var signupAction = exports.signupAction = function signupAction(userData) {
  return function (dispatch) {
    return _axios2.default.post('/api/v1/users/signup', userData).then(function (_ref) {
      ...
      dispatch(setAuthUserError(error.data.message));
    });
  };
};
...
var signinAction = exports.signinAction = function signinAction(user) {
  return function (dispatch) {
    return _axios2.default.post('/api/v1/users/signin', user).then(function (_ref3) {
      var data = _ref3.data;
